...
- `array_to_latex <https://github.com/josephcslater/array_to_latex/>`__: converts a NumPy/SciPy array to a LaTeX array including Python 3.x style `format` of the result.
